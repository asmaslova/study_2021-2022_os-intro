...
рис.2. Создание необходимых каталогов и файлов и проверка их прав доступа

![рис.3](image/8.jpg)

рис.3 Настройка прав доступа для директив
...
рис.5 Выполнение пунктов 4.1-4.5 задания
